...
useEffect(() => {
  ...
  const formatTimeString = (dataString) => {
    try {
      return format(new Date(dataString), "hh:mm a");
    ...
    {!showForm ? ( 
      ...
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          You haven't set any availability slots yet. Add your availability to allow patients to book appointments.
        </p> 
        ) : ( 
        <div>
          {slots.map((slot) => {
  ...
  <p className="text-muted-foreground text-sm">
    Setting your availability allows patients to book appointments during these times. The same availability applies to all days. You can update your availability at any time, but existing booked appointments will not be affected.
  </p>
  </div>
  </CardContent>
</Card>
