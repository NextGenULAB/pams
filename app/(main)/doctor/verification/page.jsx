  ...
  return (
    <div className="container mx-auto px-4 py-12 ">
      <div className="max-w-2xl mx-auto">
        <Card className="border-b-emerald-950/20">
          <CardHeader className="text-center">
            <div
              className={`mx-auto p-4 ${
                isRejected ? "bg-red-900/20" : "bg-amber-900"
          ...
          <CardContent>
            {isRejected ? (
              <div className="bg-red-900/10 border border-red-900/20 p-4 rounded-md flex items-start">
                <AlertCircle
              ...
              <div className="bg-amber-900/10 border border-amber-900/20 p-4 rounded-md flex items-start">
