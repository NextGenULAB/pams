    ...
    return (
      <Card className="border-emerald-900/20">
        <CardContent className="p-6 text-center">
          ...
          <p className="text-muted-foreground">Submitting your rating...</p>
        </CardContent>
      </Card>
    );
  }
    ...
    return (
      <Card className="border-emerald-900/20">
        <CardContent className="p-6 text-center">
          ...
          <p className="text-emerald-400 font-medium">Rating submitted successfully!</p>
          <p className="text-muted-foreground text-sm mt-1">Thank you for your feedback.</p>
        </CardContent>
      </Card>
    );
  }
